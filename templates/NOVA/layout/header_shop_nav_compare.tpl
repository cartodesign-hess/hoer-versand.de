{block name='layout-header-shop-nav-compare'}
    ...
    <li id="shop-nav-compare"
        ...
        {block name='layout-header-shop-nav-compare-link'}
            {link class='nav-link' data=['toggle'=>'dropdown'] aria=['haspopup'=>'true', 'expanded'=>'false', 'label'=>{lang key='compare'}, 'controls'=>'comparelist-dropdown-container']}
                <i class="fas fa-list" title="{lang key='compare'}" aria-label="{lang key='compare'}">
