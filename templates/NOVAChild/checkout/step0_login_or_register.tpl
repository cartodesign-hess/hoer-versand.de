{block name='checkout-step0-login-or-register'}
    ...
    {col cols=12 id="existing-customer" lg=4 class="checkout-existing-customer mt-3"}{* Carto: Add class 'mt-3' *}
    {block name='checkout-step0-login-or-register-form-login'}
        ...
        {block name='checkout-step0-login-or-register-fieldset-form-login-content'}
            <fieldset>
                {block name='checkout-step0-login-or-register-headline-form-login-content'}
                    <div class="h2">{lang key='alreadyCustomer'}</div>{* Carto: Change title to 'h2' *}
                {/block}
        ...
        {/block}
        {/form}
        <div id="third-party-payment-buttons-register" class="d-flex justify-content-between mt-3">
