...
{block name='basket-index-main'}
    {col cols=12 lg="{if ($Warenkorb->PositionenArr|@count > 0)}8{else}12{/if}"}{* Carto: Change col to '8' *}
...
{block name='basket-index-proceed-button' append}
    {* Carto [ch]: Add payment buttons *}
    <div id="third-party-payment-buttons-basket" class="mt-3">
        <div class="paypal"></div>
        <div class="amazon mt-2"></div>
    </div>
{/block}
