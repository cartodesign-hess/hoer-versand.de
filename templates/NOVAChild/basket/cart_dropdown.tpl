                ...
                {block name='basket-cart-dropdown-cart-items-body'}
                    <div class="dropdown-body">
                        ...
                        {block name='basket-cart-dropdown-buttons'}
                            ...
                            {col cols=12 lg=6}
                            {button variant="primary" type="link" block=true  size="sm" href="{get_static_route id='bestellvorgang.php'}?wk=1" class="cart-dropdown-next"}
                            ...
                            {/col}
                            {/row}
                            <div id="third-party-payment-buttons-minicart" class="mt-3">
